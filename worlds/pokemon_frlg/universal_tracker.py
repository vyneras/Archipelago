...
STARTING_TOWN_PC_LOCATIONS = {
    "HEAL_LOCATION_PALLET_TOWN": ["Pallet Town/PC Item", "Player's House/PC Item", "Player's House 2F PC/Item"],
    "HEAL_LOCATION_VIRIDIAN_CITY": ["Viridian City/PC Item", "Viridian Pokemon Center/PC Item",
                                    "Viridian Pokemon Center PC/Item"],
    "HEAL_LOCATION_PEWTER_CITY": ["Pewter City/PC Item", "Pewter Pokemon Center/PC Item",
                                  "Pewter Pokemon Center PC/Item"],
    "HEAL_LOCATION_CERULEAN_CITY": ["Cerulean City/PC Item", "Cerulean Pokemon Center/PC Item",
                                    "Cerulean Pokemon Center PC/Item"],
    "HEAL_LOCATION_LAVENDER_TOWN": ["Lavender Town/PC Item", "Lavender Pokemon Center/PC Item",
                                    "Lavender Pokemon Center PC/Item"],
    "HEAL_LOCATION_VERMILION_CITY": ["Vermilion City/PC Item", "Vermilion Pokemon Center/PC Item",
                                     "Vermilion Pokemon Center PC/Item"],
    "HEAL_LOCATION_CELADON_CITY": ["Celadon City/PC Item", "Celadon Pokemon Center/PC Item",
                                   "Celadon Pokemon Center PC/Item"],
    "HEAL_LOCATION_FUCHSIA_CITY": ["Fuchsia City/PC Item", "Fuchsia Pokemon Center/PC Item",
                                   "Fuchsia Pokemon Center PC/Item"],
    "HEAL_LOCATION_CINNABAR_ISLAND": ["Cinnabar Island/PC Item", "Cinnabar Pokemon Center/PC Item",
                                      "Cinnabar Pokemon Center PC/Item"],
    "HEAL_LOCATION_INDIGO_PLATEAU": ["Indigo Plateau/PC Item", "Indigo Plateau Pokemon Center/PC Item",
                                     "Indigo Plateau Pokemon Center PC/Item"],
    "HEAL_LOCATION_SAFFRON_CITY": ["Saffron City/PC Item", "Saffron Pokemon Center/PC Item",
                                   "Saffron Pokemon Center PC/Item"],
    "HEAL_LOCATION_ROUTE4": ["Route 4 West/PC Item", "Route 4 Pokemon Center/PC Item",
                             "Route 4 Pokemon Center PC/Item"],
    "HEAL_LOCATION_ROUTE10": ["Route 10 North/PC Item", "Route 10 Pokemon Center/PC Item",
                              "Route 10 Pokemon Center PC/Item"],
    "HEAL_LOCATION_ONE_ISLAND": ["One Island Town/PC Item", "One Island Pokemon Center/PC Item",
                                 "One Island Pokemon Center PC/Item"],
    "HEAL_LOCATION_TWO_ISLAND": ["Two Island Town/PC Item", "Two Island Pokemon Center/PC Item",
                                 "Two Island Pokemon Center PC/Item"],
    "HEAL_LOCATION_THREE_ISLAND": ["Three Island Town/PC Item", "Three Island Pokemon Center/PC Item",
                                   "Three Island Pokemon Center PC/Item"],
    "HEAL_LOCATION_FOUR_ISLAND": ["Four Island Town/PC Item", "Four Island Pokemon Center/PC Item",
                                  "Four Island Pokemon Center PC/Item"],
    "HEAL_LOCATION_FIVE_ISLAND": ["Five Island Town/PC Item", "Five Island Pokemon Center/PC Item",
                                  "Five Island Pokemon Center PC/Item"],
    "HEAL_LOCATION_SEVEN_ISLAND": ["Seven Island Town/PC Item", "Seven Island Pokemon Center/PC Item",
                                   "Seven Island Pokemon Center PC/Item"],
    "HEAL_LOCATION_SIX_ISLAND": ["Six Island Town/PC Item", "Six Island Pokemon Center/PC Item",
